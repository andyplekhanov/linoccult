...
namespace CGLA {
	...
	public:
		...
		/// Construct from a pointed to array of 16 doubles.
		Mat4x4f(const double* sa): ArithSqMat<Vec4f, Mat4x4f, 4> (sa) {}
	...
	Mat4x4f rotation_Mat4x4f(CGLA::Axis axis, double angle);
	...
	double determinant(const Mat4x4f&);
	...
	/** Create a perspective matrix. Assumes the eye is at the origin and
			...
			THIS ONE */
	Mat4x4f perspective_Mat4x4f(double d);
