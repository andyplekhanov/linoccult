...
#define M_PI 3.1415926
	...
	public:
		...
		Quaternion(const Vec3f _qv, double _qw=1) : 
			qv(_qv) , qw(_qw) {}

		/// Construct quaternion from four scalars
		Quaternion(double x, double y, double z, double _qw) : 
			qv(x,y,z), qw(_qw) {}
		...
		void make_rot(double angle, const Vec3f&);
		...
		void get_rot(double& angle, Vec3f&);
	...
	/// Multiply scalar onto quaternion
	inline Quaternion operator *(double scalar, Quaternion quat) 
	{
	...
	*/
	...
	{
		double angle=acos(q0.qv[0]*q1.qv[0]+q0.qv[1]*q1.qv[1]+q0.qv[2]*q1.qv[2]+q0.qw*q1.qw);
